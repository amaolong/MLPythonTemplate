...
xgb_params['reg_alpha'] = [0.4, 0.8]  # l1 regularization
xgb_params['reg_lambda'] = [0.4, 0.8]  # l2 regularization
xgb_params['colsample_bytree'] = [0.8, 1]
xgb_params['colsample_bylevel'] = [0.8, 1]
'''
...
lgbm_params['colsample_bytree'] =[0.8]
lgbm_params['max_bin']=[255]
lgbm_params['min_child_samples']=[2,10,20]
lgbm_params['min_child_weight'] =[0.001]
lgbm_params['min_split_gain'] =[0]
lgbm_params['nthread'] =[5]
lgbm_params['reg_alpha'] =[0.4,0.8]
lgbm_params['reg_lambda'] =[0.4,0.8]
